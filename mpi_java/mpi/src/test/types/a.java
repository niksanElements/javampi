...
public class a{
	...
	static String[] h_hapes = {"Id"};
	static Datatype[] h_types = {MPI.INT};
	static int[] h_counts = {1};
	static Datatype here = new Datatype(h_hapes, h_types, h_counts, Here.class);

    static String[] names = {"Age","Name","Some","Here","H"};
    static Datatype[] types = { MPI.INT,MPI.INT,MPI.LONG,here,here};
    static int[] counts = {1,10,20,1,3};
    ...
    public static void main(String[] args) {
    	...
    	if(rank == 0) {
	        ...
	        Here h = new Here();
	        Here[] hs = new Here[3];
	        hs[0] = new Here(); hs[0].setId(13);
	        hs[1] = new Here(); hs[1].setId(14);
	        hs[2] = new Here(); hs[2].setId(15);
	        h.setId(12);
	        p.setHere(h); p.setH(hs);
