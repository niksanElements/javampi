...
public class Reduceco {
    ...
    public static void main(String[] args) {
        ...
        Here[] hSend = new Here[10];Here[] hRecv = new Here[3];
        hSend[0] = new Here();hSend[0].setId(rank);
        ByteBuffer buff = ByteBuffer.allocateDirect(124);
        ByteBuffer buff1= ByteBuffer.allocateDirect(124);
        long start = System.nanoTime();
        MPI.COMM_WORLD.reduce(hSend, hRecv, 0, 0, 1, her, op, 0, buff,buff1);
